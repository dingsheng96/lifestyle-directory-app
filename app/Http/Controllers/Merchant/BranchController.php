...
class BranchController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('merchant.branch.create', compact('max_files'));
    }
    ...
    public function show(User $branch)
    {
        ...
        return view('merchant.branch.show', compact('branch', 'image_and_thumbnail'));
    }
    ...
    public function edit(User $branch)
    {
        ...
        return view('merchant.branch.edit', compact('branch', 'max_files', 'image_and_thumbnail'));
    }
