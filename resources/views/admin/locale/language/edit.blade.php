...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="card shadow">
                ...
                <form action="{{ route('admin.locales.languages.update', ['language' => $language->id]) }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    @method('put')
    ...
    @include('admin.locale.language.import')
