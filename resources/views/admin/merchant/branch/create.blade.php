        ...
        <div class="col-12">
            <div class="card shadow border">
                ...
                <div class="card-header bg-transparent border-0">
                    <span class="h5">{{ __('modules.create', ['module' => __('labels.merchant_branch', ['merchant' => $merchant->name])]) }}</span>
                </div>

                <form action="{{ route('admin.merchants.branches.store', ['merchant' => $merchant->id]) }}" method="post" role="form" enctype="multipart/form-data">
                    @csrf
