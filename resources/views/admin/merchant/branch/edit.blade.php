        ...
        <div class="col-12 col-md-3">
            <div class="card shadow border">
                <div class="card-header bg-transparent border-0">
                    <span class="h5">{{ Str::limit(__('modules.edit', ['module' => __('labels.merchant_branch', ['merchant' => $merchant->name])]), 30) }}</span>
                </div>
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="dropzone" id="myDropzone" data-max-files="{{ $max_files }}" data-accepted-files=".jpg,.jpeg,.png" data-action="update">
                                        <div class="dz-default dz-message">
                                            ...
                                            <ul class="list-unstyled">
                                                {!! trans_choice('messages.upload_file_rules', 2, [
                                                'maxsize' => '10mb',
                            ...
                            <div class="tab-pane fade" id="list-reviews" role="tabpanel" aria-labelledby="list-reviews-list">
                                <iframe src="{{ route('admin.reviews.index', ['merchant_id' => $merchant->id, 'branch_id' => $branch->id]) }}" frameborder="0" style="width: 100%; min-height:80vh;"></iframe>
                            </div>
                        </div>
                    </div>
