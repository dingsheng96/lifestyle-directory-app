            ...
            <div class="card card-body shadow border">
                ...
                <form method="POST" action="{{ route('password.update') }}" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="login-text">{{ __('labels.email') }}</label>
                    ...
                    <div class="form-group">
                        <label class="login-text">{{ __('labels.password') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        <label class="login-text">{{ __('labels.password_confirmation') }} <span class="text-danger">*</span></label>
