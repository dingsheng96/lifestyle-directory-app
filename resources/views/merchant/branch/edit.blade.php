@extends('merchant.layouts.master', ['title' => trans_choice('labels.branch', 2)])
            ...
            <div class="card shadow">
                ...
                <form action="{{ route('merchant.branches.update', ['branch' => $branch->id]) }}" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="list-gallery" role="tabpanel" aria-labelledby="list-gallery-list">
                                ...
                                <div class="form-group">
                                    @include('merchant.components.tbl_image', ['images' => $image_and_thumbnail, 'thumbnail' => true, 'action' => true])
                                </div>
                    ...
                    <div class="card-footer bg-transparent text-md-right text-center">
                        <a href="{{ route('merchant.branches.index') }}" role="button" class="btn btn-light mx-2">
