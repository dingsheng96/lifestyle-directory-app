@extends('layouts.master', ['title' => __('labels.account_setup')])

@section('content')

<div id="register" class="my-5">
    <div class="container">
        <h2 class="heading">{!! trans('labels.account_setup') !!}</h2><br><br>
    </div>
    <div class="form-bg">
        <div id="reg-form" class="container">
            <form action="{{ route('merchant.account.setup', ['user' => $merchant->id]) }}" method="post" role="form" enctype="multipart/form-data" class="py-5">
                @csrf
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-12 col-lg-6 mb-4">
                        <div class="form-group-lg">
                            <label for="name" class="label-text">{!! trans('labels.company_name') !!}</label>
                            <input type="text" id="name" value="{{ $merchant->name }}" class="form-control form-control-lg ucfirst @error('name') is-invalid @enderror" disabled>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 mb-4">
                        <div class="form-group-lg">
                            <label for="contact" class="label-text">{!! trans('labels.company_contact_no') !!}</label>
                            <input type="text" name="phone" id="phone" value="{{ $merchant->mobile_no  }}" class="form-control form-control-lg @error('phone') is-invalid @enderror" disabled>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 mb-4">
                        <div class="form-group-lg">
                            <label for="email" class="label-text">{!! trans('labels.email') !!} ({!! trans('labels.username') !!})</label>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-12 mb-4">
                        <div class="form-group-lg">
                            <label for="pic_name" class="label-text">{{ __('labels.full_name_as_nric') }}</label>
                            <div class="form-row">
                                <input type="text" name="pic_name" id="pic_name" value="{{ $merchant->branchDetail->pic_name }}" class="form-control form-control-lg @error('pic_name') is-invalid @enderror" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 mb-4">
